...
if docker_tag_exists svenruppert/liberica 1.8.212; then
    ...
    docker tag svenruppert/liberica:latest svenruppert/liberica:1.8.212
    docker push svenruppert/liberica:1.8.212

fi 
    docker image rm svenruppert/liberica:latest
    docker image rm svenruppert/liberica:1.8.212