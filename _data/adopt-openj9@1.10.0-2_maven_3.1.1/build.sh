...
if docker_tag_exists svenruppert/maven-3.1.1-adopt-openj9 1.10.0-2; then
    echo skip building, image already existing - svenruppert/maven-3.1.1-adopt-openj9 1.10.0-2
else
