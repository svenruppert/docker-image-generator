...
if docker_tag_exists svenruppert/maven-3.3.9-openjdk-shenandoah 1.11.0; then
    echo skip building, image already existing - svenruppert/maven-3.3.9-openjdk-shenandoah 1.11.0
else
