...
public class Generator {
  ...
  private static final String MVN_BUILD_SH = "if docker_tag_exists svenruppert/maven-{0}-{1} {2}; then\n"
                                             ...
                                             + "\n"
                                             + "fi \n"
                                             + "    docker image rm svenruppert/maven-{0}-{1}:latest\n"
                                             + "    docker image rm svenruppert/maven-{0}-{1}:{2}";
  ...
  private static final String BUILD_SH = "if docker_tag_exists svenruppert/{0} {1}; then\n"
                                         ...
                                         + "\n"
                                         + "fi \n"
                                         + "    docker image rm svenruppert/{0}:latest\n"
                                         + "    docker image rm svenruppert/{0}:{1}";
...
//                                                   .collect(toList());
  ...
  public static final String MVN_VERSIONS = "3.6.3\n"
                                            //+ "3.8.8\n"
                                            + "3.9.2\n";

  //generate this list with -> jabba ls-remote --os linux
  private static String VERSIONS = "amazon-corretto@20.0.1\n"
                                   +"amazon-corretto@17.0.7\n"
                                   +"amazon-corretto@11.0.19\n"
                                   //+"graalvm@22.3.1\n"
                                   ...
                                   //+"oracle@20.0.1\n"
                                   //+"oracle@17.0.7\n"
                                   +"oracle_open_jdk@20.0.1\n"
                                   +"oracle_open_jdk@17.0.2\n"
                                   +"semeru@17.0.7\n"
                                   +"semeru@11.0.19\n"
                                   //+"temurin@20.0.1\n"
                                   +"temurin@17.0.7\n"
